...
export interface NavLeaf {
  ...
  unreadDot?: boolean;
  /** Opens in a new tab via a plain <a> instead of a router Link */
  external?: boolean;
}
  ...
  if (item.external) {
    return (
      <a
        ...
        className="flex items-center justify-between px-3 py-2 text-sm rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors"
      >
